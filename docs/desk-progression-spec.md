...
> Fifth concrete office-system feature for Hermes3D, connecting visible office presence to role maturity, permissions, and capability growth.
...
Desk progression should integrate with real Hermes3D systems rather than sit beside them.

### Permissions

Hermes3D already has permission and approval surfaces.
